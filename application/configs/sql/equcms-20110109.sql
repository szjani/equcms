...
--
-- Hoszt: localhost
-- Létrehozás ideje: 2011. jan. 09. 13:02
...
(9, 'group', 'admin', ''),
(10, 'group', 'admin', 'list'),
(11, 'group', 'admin', 'create'),
(12, 'permission', 'admin', ''),
(13, 'permission', 'admin', 'list'),
(14, 'permission', 'admin', 'create'),
(15, 'mvc', 'admin', 'update'),
(16, 'user', 'admin', 'update'),
(17, 'group', 'admin', 'update'),
(18, 'permission', 'admin', 'update');
...
(9, 2, 19, 26, 2, 'mvc:group.admin', 'mvc'),
(10, 9, 20, 21, 3, 'mvc:group.admin.list', 'mvc'),
(11, 9, 22, 23, 3, 'mvc:group.admin.create', 'mvc'),
(12, 2, 27, 34, 2, 'mvc:permission.admin', 'mvc'),
(13, 12, 28, 29, 3, 'mvc:permission.admin.list', 'mvc'),
(14, 12, 30, 31, 3, 'mvc:permission.admin.create', 'mvc'),
(15, 3, 8, 9, 3, 'mvc:mvc.admin.update', 'mvc'),
(16, 6, 16, 17, 3, 'mvc:user.admin.update', 'mvc'),
(17, 9, 24, 25, 3, 'mvc:group.admin.update', 'mvc'),
(18, 12, 32, 33, 3, 'mvc:permission.admin.update', 'mvc');
...
(1, NULL, 1, 6, 0, 'Everybody', 'usergroup'),
(2, 3, 3, 4, 1, 'szjani@szjani.hu', 'user'),
(3, 1, 2, 5, 1, 'Administrators', 'usergroup');
...
(2, 'szjani@szjani.hu', 'f2685fd6c2bfe8f7b9dafc99bfb15006', 'FugqdLSD0Ucp');
