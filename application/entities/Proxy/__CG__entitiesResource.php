 ...
 */
class Resource extends \entities\Resource implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'lft', 'rgt', 'lvl', 'resource', 'parent', 'children', 'roleResources');
    }
