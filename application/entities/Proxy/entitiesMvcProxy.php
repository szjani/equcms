 ...
 */
class entitiesMvcProxy extends \entities\Mvc implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'parent', 'children', 'lft', 'rgt', 'lvl', 'resource', 'roleResources', 'module', 'controller', 'action');
    }
